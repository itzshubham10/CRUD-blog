 <?php
    ...
    if (isset($_POST['submit'])) {
        ...
        if (!$title) {
            ...
            // delete existing thumbnail ifnew is available
            if ($thumbnail['name']) {
                $previous_thumbnail_path = '../images/' . $previous_thumbnail_path;
        ...
        // redirect back (with form data ) to add-post page if there ian any problem
        ...
        if ($_SESSION['edit-post']) {
            ...
            // set is_featured of all posts to 0 if is_featured for all this post is  1
            if ($is_featured == 1) {
                $zero_all_is_featured_query = "UPDATE posts SET is_featured=0";
                $zero_all_is_featured_result = mysqli_query($connection, $zero_all_is_featured_query);
            }
            //   set thumbnail name if new one was uploaded
